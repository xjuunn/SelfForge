...
fn app_advance_prepares_candidate_when_none_exists() {
    ...
    assert_eq!(report.starting_version, "v0.1.67");
    assert_eq!(report.stable_version, "v0.1.67");
    assert_eq!(report.candidate_version.as_deref(), Some("v0.1.68"));
    assert_eq!(report.next_expected_version.as_deref(), Some("v0.1.69"));
...
fn app_advance_promotes_candidate_and_prepares_next_candidate() {
    ...
    assert_eq!(report.starting_version, "v0.1.67");
    assert_eq!(report.stable_version, "v0.1.68");
    assert_eq!(report.candidate_version.as_deref(), Some("v0.1.69"));
    assert_eq!(report.next_expected_version.as_deref(), Some("v0.1.70"));
