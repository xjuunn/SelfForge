...
pub use minimal_loop::{
    ...
    AiPatchSourceExecutionError, AiPatchSourceExecutionReport, AiPatchSourcePlanError,
    AiPatchSourcePlanReport, AiPatchSourcePromotionError, AiPatchSourcePromotionReport,
