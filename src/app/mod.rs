...
pub use minimal_loop::{
    ...
    AiPatchPreviewError, AiPatchPreviewReport, AiPatchSourceCandidateError,
    AiPatchSourceCandidateReport, AiPatchSourceCycleError, AiPatchSourceCycleReport,
    AiPatchSourceCycleSummaryError, AiPatchSourceCycleSummaryReport, AiPatchSourceExecutionError,
    AiPatchSourceExecutionReport, AiPatchSourcePlanError, AiPatchSourcePlanReport,
    AiPatchSourcePromotionError, AiPatchSourcePromotionReport, AiPatchSourceTaskDraftError,
    AiPatchSourceTaskDraftReport, AiPatchVerificationCommandSpec, AiPatchVerificationError,
    AiPatchVerificationReport, AiSelfUpgradeError, AiSelfUpgradePreview, AiSelfUpgradeReport,
    AiSelfUpgradeSummaryError, AiSelfUpgradeSummaryReport, MinimalLoopError, MinimalLoopOutcome,
