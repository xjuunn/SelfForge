...
pub use agent::{
    ...
    AiSelfUpgradeSummaryStoreError,
};
pub use ai_provider::{
...
pub use minimal_loop::{
    ...
    AiPatchSourceCandidateReport, AiPatchSourceExecutionError, AiPatchSourceExecutionReport,
    AiPatchSourcePlanError, AiPatchSourcePlanReport, AiPatchSourcePromotionError,
    AiPatchSourcePromotionReport, AiPatchVerificationCommandSpec, AiPatchVerificationError,
