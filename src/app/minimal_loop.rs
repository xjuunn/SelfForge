...
use self::patch_scope::{
    audit_patch_scope_conflicts, audit_patch_write_scope, extract_patch_audit_write_scope,
    markdown_heading_title, normalize_patch_scope_path, patch_audit_protected_roots,
};
